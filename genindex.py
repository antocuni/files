...
def generate_index(directory):
    ...
    GENINDEX_MARKER = '<!-- generated by genindex.py -->'

    # If index.html already exists and was NOT generated by us, skip it
    index_path = path / 'index.html'
    if index_path.exists():
        existing = index_path.read_text(encoding='utf-8', errors='ignore')
        if GENINDEX_MARKER not in existing:
            print(f"Skipping {index_path} (not generated by genindex)")
            return
